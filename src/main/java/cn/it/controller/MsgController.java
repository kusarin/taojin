...
import cn.it.websocket.MyWebSocketHandler;
...
public class MsgController {
	...
	public ModelAndView doLogin(Users user, HttpServletRequest request) {
		request.getSession().setAttribute("uid", user.getUser_ID());
		request.getSession().setAttribute("name", users.get(user.getUser_ID()).getName());
