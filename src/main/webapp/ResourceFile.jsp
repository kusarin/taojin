						...
						<section id="latestblog">
							<div class="blogdetail">
								...
								<div class="pull-right">
									<a href="addRF.jsp"><input type="button" value="新增文件资源" class="btn btn-orange"/></a>
								</div>
								<div class="mb20">
												...
												<h2 class="heading2">
													...
													<div  align="center">
														<form action="findResourceFile.do" method="post">
																<c:choose>
																<c:when test="${page != 1}">
																	<a href="findResourceFile.do?page=${page-1}"><input type="button" name="lastPage" value="上一页" class="btn btn-orange"/></a>
																</c:when>
																<c:otherwise>
