							...
							<div class="blogdetail">
								...
								<div class="mb20">
									<section class="leavecomment">
											...
											<tbody>  
									            ...
									            <c:forEach items="${shop}" var="s">  
									              <tr>  
									                ...
									                <td> ${s.type}</td>  
									                <td align="center">
									                	<a href="./findShop.do?id=${s.shop_id}">查看</a>
									                </td> 
									              </tr>  
									            </c:forEach>  
											</tbody>
										...
										<br>
										<div  align="center">
											<form action="shopManage.do" method="post">
															<c:choose>
															<c:when test="${page != 1}">
																<a href="shopManage.do?page=${page-1}"><input type="button" name="lastPage" value="上一页" class="btn btn-orange"/></a>
															</c:when>
															<c:otherwise>
													...
													<!-- 页数列表 -->
														<c:forEach items="${pageList}" var="pn">
															<c:choose>
																...
																<c:otherwise>
																	<a href="shopManage.do?page=${pn}"><U>${pn}</U></a>
																</c:otherwise>
															</c:choose>
														</c:forEach>
													<!-- 下一页 按钮 -->
														<c:choose>
															<c:when test="${page != totalPage}">
																<a href="shopManage.do?page=${page+1}">
