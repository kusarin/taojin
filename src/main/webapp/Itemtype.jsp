...
<body>
	...
	<div class="menu">
		...
		<div class="nav">
			<ul class="clearfix">
				<li><a href="http://sc.chinaz.com" class="current">首页</a></li>
				<li><a href="http://sc.chinaz.com">服装城</a></li>
				<li><a href="http://sc.chinaz.com">京东超市</a></li>
				<li><a href="http://sc.chinaz.com">团购</a></li>
				<li><a href="http://sc.chinaz.com">拍卖</a></li>
				<li><a href="http://sc.chinaz.com">在线游戏</a></li>
			</ul>
		</div>
	</div>
	<!--导航 End-->
