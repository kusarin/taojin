		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="sidewidt">
					...
					<ul class="nav nav-list categories">
						...
						<li><a href="waittingDeGoods.do?shop_id=${shopid}&flag=0">订单管理</a>
							<ul>
								<a href="alreadyReGoods.do?shop_id=${shopid}&flag=1"
									style="color: red;">已处理</a>
							</ul>
							<ul>
								<a href="waittingDeGoods.do?shop_id=${shopid}&flag=0">未处理</a>
							</ul></li>
					</ul>
				...
				<div
					...
					<c:if test="${pages.totalpage==0 || pages.pageNo==pages.totalpage}">
