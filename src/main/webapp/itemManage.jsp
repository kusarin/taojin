												...
												<h2 class="heading2">
													 	...
													 	<tbody>  
													            ...
													            <c:forEach items="${item}" var="i">  
													              <tr>  
													                ...
													                <td> ${i.typel}</td>  
													                <td align="center">
													                	<a href="./findItem.do?id=${i.item_id}">查看</a>
													                </td> 
													              </tr>  
													            </c:forEach>  
														</tbody>
													...
													<div  align="center">
														<form action="itemManage.do" method="post">
																<c:choose>
																<c:when test="${page != 1}">
																	<a href="itemManage.do?page=${page-1}"><input type="button" name="lastPage" value="上一页"  class="btn btn-orange"/></a>
																</c:when>
																<c:otherwise>
														...
														<!-- 页数列表 -->
															<c:forEach items="${pageList}" var="pn">
																<c:choose>
																	...
																	<c:otherwise>
																		<a href="itemManage.do?page=${pn}"><U>${pn}</U></a>
																	</c:otherwise>
																</c:choose>
															</c:forEach>
														<!-- 下一页 按钮 -->
